...
public class DoubleLinkedList<E> { 
    ...
    /**
     * swap method to change locations around in a list
    ...
    /**
     * getNode method to get the entire node
     * @param index, the index where the node of the index we are looking for is stored
     * @return currentNode the node stored
     */
    ...
    /**
     * get method to get the item stored in the node
     * @param index, the index where the element is being stored.
     * @return item, the item wanted
     */
    ...
    /**
     * indexOf method to find a certain item in list
     * @param item the item to search for
     * @return i the location in list or -1 if not found
     */
