...
public class PokemonDawn {
    ...
    public static URL getResource(String name) {
        return PokemonDawn.class.getResource(name);
    }
    ...
    public static void loadPokemonData(URL dataFile) {
        if (dataFile == null) {
        ...
        Scanner file = null;
        try {
            file = new Scanner(dataFile.openStream());
        } catch (Exception e) {
        }
    ...
    public static void main(String[] args) {
        ...
        URL pokemonFile = getResource("pokemon.txt");
